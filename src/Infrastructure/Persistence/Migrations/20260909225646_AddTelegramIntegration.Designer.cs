...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260909225646_AddTelegramIntegration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Board", b =>
                {
                    ...
                    b.Property<string>("SmartsheetSheetId")
            ...
            modelBuilder.Entity("Domain.Entities.BoardCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.PersonAvailability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PersonAvailability", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.SmartsheetSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ProgressColumn")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("StatusColumn")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.ToTable("SmartsheetSettings", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.TelegramEnrolment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<long?>("RedeemedByTelegramUserId")
                    ...
                    b.ToTable("TelegramEnrolments", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.TelegramLink", b =>
                {
                    ...
                    b.ToTable("TelegramLinks", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.TelegramMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.TelegramSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AllowedChatIds")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("LastPollResult")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<bool>("ReplyToUnknownSenders")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Entities.Board", b =>
                {
                    b.HasOne("Domain.Entities.BoardCategory", "Category")
                        .WithMany()
